        ...
        <div class="row flex-row-reverse">
            ...
            <div class="admin-content col-9">
                <div class="container">
                    ...
                    @endif
                    <form
                        action="{{ isset($responsible) ? route('admin.responsible.update', $responsible->id) : route('admin.responsible.store') }}"
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" class="form-control" type="text"
                                            value="{{ isset($responsible) ? $responsible->name : old('name') }}" required>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="body" class="form-control" id="body" rows="5np"
                                            placeholder="تفاصيل اكثر"
                                            required>{{ isset($responsible) ? $responsible->body : old('body') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mx-auto">
                                    <button type="submit"
                                        class="btn btn-primary btn-block">{{ isset($responsible) ? __('تحديث') : __('حفظ') }}</button>
                                </div>
                            </div>
                            {{-- </div> --}}
                        </div>
