        ...
        <div class="row flex-row-reverse">
            ...
            <div class="admin-content col-9">
                <div class="container">
                    ...
                    <h1 class="text-center">كل الفروع</h1>

                    <div class="mb-3">
                        <a href="{{ isset($projects) ? route('project.create') : route('admin.branch.create') }}"
                            class="btn btn-success">{{ isset($projects) ? 'إضافة مشروع جديد' : 'إضافة فرع جديد' }}</a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex btn btn-info btn-table">
                                                    <a href="{{ route('admin.branch.show', $item->id) }}"><i
                                                            class="fas fa-eye"></i></a>
                                                </div>
                                                <div class="flex btn btn-warning btn-table mx-3">
                                                    <a href="{{ route('admin.branch.edit', $item->id) }}"><i
                                                            class="fas fa-cog"></i></a>
                                                </div>
                                                <div class="flex btn btn-danger btn-table">
                                                    <button onclick="handldelete2('branch/{{ $item->id }}')"
