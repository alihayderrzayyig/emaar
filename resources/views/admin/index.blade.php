            ...
            <div class="admin-content col-9 pl-0">
                ...
                <div class="container p-5">
                    ...
                    <div class="row">
                        <div class="col-5 mx-auto">
                            <div class="d-flex flex-row-reverse justify-content-around mb-5">
                                <a href="{{ route('admin.situation.waiting') }}"
                    ...
                    <div class="row">
                        <div class="col-5 mx-auto">
                            <div class="d-flex flex-row-reverse justify-content-around mb-5">
                                <a href="{{ route('admin.joinus.index') }}"
                ...
                <div class="container p-5" style="background-color: rgb(220, 230, 247)">
                        ...
                        <table dir="rtl" class="table table-striped" style="overflow-y:auto;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 40px; height: 30px;"
                                            src="{{ asset('img/achievements01.jpg') }}" alt="">
                                    </td>
                                    <td>(550*480)</td>
                                    {{-- <td>{{ $user->email }}</td> --}}
                                    <td>
                                        <div class="ml-2 flex btn btn-warning btn-table">
                                            <button onclick="handledit('achievements01.jpg')" type="button"
                                                data-toggle="modal" data-target="#ching-img"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 40px; height: 30px;"
                                            src="{{ asset('img/achievements02.jpg') }}" alt="">
                                    </td>
                                    <td>(270*320)</td>
                                    {{-- <td>{{ $user->email }}</td> --}}
                                    <td>
                                        <div class="ml-2 flex btn btn-warning btn-table">
                                            <button onclick="handledit('achievements02.jpg')" type="button"
                                                data-toggle="modal" data-target="#ching-img"><i
                                                    class="fas fa-cog"></i></button>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 40px; height: 30px;"
                                            src="{{ asset('img/achievements03.jpg') }}" alt="">
                                    </td>
                                    <td>(270*320)</td>
                                    {{-- <td>{{ $user->email }}</td> --}}
                                    <td>
                                        <div class="ml-2 flex btn btn-warning btn-table">
                                            <button onclick="handledit('achievements03.jpg')" type="button"
                                                data-toggle="modal" data-target="#ching-img"><i
                                                    class="fas fa-cog"></i></button>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 40px; height: 30px;"
                                            src="{{ asset('img/achievements04.jpg') }}" alt="">
                                    </td>
                                    <td>(265*480)</td>
                                    {{-- <td>{{ $user->email }}</td> --}}
                                    <td>
                                        <div class="ml-2 flex btn btn-warning btn-table">
                                            <button onclick="handledit('achievements04.jpg')" type="button"
                                                data-toggle="modal" data-target="#ching-img"><i
                                                    class="fas fa-cog"></i></button>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 40px; height: 30px;"
                                            src="{{ asset('img/achievements05.jpg') }}" alt="">
                                    </td>
                                    <td>(265*240)</td>
                                    {{-- <td>{{ $user->email }}</td> --}}
                                    <td>
                                        <div class="ml-2 flex btn btn-warning btn-table">
                                            <button onclick="handledit('achievements05.jpg')" type="button"
                                                data-toggle="modal" data-target="#ching-img"><i
                                                    class="fas fa-cog"></i></button>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 40px; height: 30px;"
                                            src="{{ asset('img/achievements06.jpg') }}" alt="">
                                    </td>
                                    <td>(265*240)</td>
                                    {{-- <td>{{ $user->email }}</td> --}}
                                    <td>
                                        <div class="ml-2 flex btn btn-warning btn-table">
                                            <button onclick="handledit('achievements06.jpg')" type="button"
                                                data-toggle="modal" data-target="#ching-img"><i
                                                    class="fas fa-cog"></i></button>
                                        </div>
                                    </td>
                    ...
                    <!-- View Modal -->
                    <!-- Modal -->
                    <div class="modal fade" id="ching-img" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                                    ...
                                    @foreach ($responsibles as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="ml-2 flex btn btn-warning btn-table ">
                                                    <a href="{{ route('admin.responsible.edit', $item->id) }}"><i
                                                            class="fas fa-cog"></i></a>
                                                </div>
                                                <div class="flex btn btn-danger btn-table ml-2">
                                                    <button
                                                        onclick="handldelete2('/admin/responsible/{{ $item->id }}')"
