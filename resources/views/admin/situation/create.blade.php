                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" class="form-control" type="text"
                                            value="{{ isset($situation) ? $situation->name : '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="phone" name="phone" class="form-control" type="text"
                                            value="{{ isset($situation) ? $situation->phone : '' }}">
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-6 col-md-4 col-lg-4 mb-3">
                                                <select name="governorate" id="test" class="custom-select">
                                                    ...
                                                    @foreach ($governorates as $governorate)
                                                        <option value="{{ $governorate->id }}" @if (isset($situation) && $situation->governorate == $governorate->id) selected @endif>
                                                ...
                                                <select name="district" class="custom-select">
                                                    @if (isset($situation))
                                                        @foreach ($districts as $district)
                                                            <option value="{{ $district->id }}" @if (isset($situation) && $situation->district == $district->id) selected @endif>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-4 col-lg- mb-34 ">
                                                <input name="region" class="form-control" type="text"
                                                    placeholder="منطقة/ناحية"
                                                    value="{{ isset($situation) ? $situation->region : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="money" name="money" class="form-control" type="text"
                                            value="{{ isset($situation) ? $situation->money : '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="des" name="description" class="form-control"
                                            id="exampleFormControlTextarea1" rows="5np"
                                            placeholder="">{{ isset($situation) ? $situation->description : '' }}</textarea>
                                    </div>
                                </div>
                                ...
                                @if (isset($situation))
                                    <div class="col-12">
                                        <div class="form-group">
                                            <img src="{{ asset($situation->image) }}" alt="" srcset=""
                                        ...
                                        <fieldset class="form-group">
                                            <div class="form-check">
                                                ...
                                                <input class="form-check-input" type="radio" name="status" id="gridRadios1"
                                                    value="1" @if (isset($situation) && $situation->status) checked @endif>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="status" id="gridRadios2"
                                                    value="0" @if (isset($situation) && $situation->status == 0) checked @endif>
                                ...
                                <div class="mx-auto">
                                    <button type="submit"
                                        class="btn btn-primary btn-block">{{ isset($situation) ? 'تحديث' : 'حفظ' }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
