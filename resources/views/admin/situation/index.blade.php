        ...
        <div class="row flex-row-reverse">
            ...
            <div class="admin-content col-9">
                <div class="container">
                    ...
                    <form action="{{ isset($accept) ? route('admin.situation.waiting') : route('admin.situation.index') }}" method="get" class="mb-4">
                        <div class="input-group flex-row-reverse mb-3">
                            <input type="text" value="{{ request()->query('search') }}" name="search" class="form-control" placeholder="بحث"
