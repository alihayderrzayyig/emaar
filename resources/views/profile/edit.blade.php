                  ...
                  <div class="row justify-content-between">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                      <div class="form-group">
                        ...
                        <input id="phone" name="phone" class="form-control" type="text" value="{{ $user->profile->phone }}">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                      <div class="form-group">
                        ...
                        <input id="birthdate" name="birthdate" class="form-control" type="date" value="{{ $user->profile->birthdate }}">
                      </div>
                    </div>
                        ...
                        <label for="governorate">عنوان السكن:</label>
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg- mb-3">
                                    <input name="region" class="form-control" type="text" value="{{ $user->profile->region }}">
                                </div>
                            </div>
                        </div>
                    </div>
